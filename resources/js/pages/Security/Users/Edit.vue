...
import { edit as usersEdit, index as usersIndex, update as usersUpdate } from '@/routes/security/users'
...
const form = useForm({
    ...
    password: '',
    company_id: props.user.company_id ?? (props.companies.length ? props.companies[0].id : null),
